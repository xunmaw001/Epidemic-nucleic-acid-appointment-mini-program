<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="在岗时间" prop="zaigangshijian">
          <el-input v-model="ruleForm.zaigangshijian" 
              placeholder="在岗时间" clearable  :readonly="ro.zaigangshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="在岗时间" prop="zaigangshijian">
              <el-input v-model="ruleForm.zaigangshijian" 
                placeholder="在岗时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangxidizhi = true;
          ...
          if(o=='zaigangshijian'){
            this.ruleForm.zaigangshijian = obj[o];
	    this.ro.zaigangshijian = true;
            continue;
          }
          if(o=='zixundianhua'){
	...
	this.ruleForm.zhandianxiangqing = this.ruleForm.zhandianxiangqing.replace(reg,'../../../springbootyc1mt/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiancezhandian/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiancezhandianCrossAddOrUpdateFlag = false;
						 this.parent.search();
