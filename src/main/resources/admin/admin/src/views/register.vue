  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="电话号码" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.dianhuahaoma" autocomplete="off" placeholder="电话号码"  />
			</el-form-item>
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20210524/5659e131fff14912b4c56bebaadaf979.png);
